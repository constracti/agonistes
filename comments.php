...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() && comments_open() /* constracti: hide comments if status is closed */ ) : ?>
	...
	<?php
		...
		if ( ! comments_open() /* && '0' != get_comments_number() && post_type_supports( get_post_type(), 'comments' ) */ /* constracti: always display notice */ ) :
	?>
